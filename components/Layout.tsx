...
const Layout: React.FC<LayoutProps> = ({ children, lang, setLang }) => {
  ...
  const siteLinks = [
    ...
    { to: `${prefix}/annuaire-partenaires`, label: lang === 'fr' ? 'Annuaire Pro' : 'دليل المهنيين' },
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4 rtl:space-x-reverse">
              ...
              <NavLink to={`${prefix}/annuaire-partenaires`} className={({isActive}) => isActive ? 'text-medical-600 font-semibold' : 'text-gray-600 hover:text-medical-600'}>{lang === 'fr' ? 'Annuaire Pro' : 'دليل المهنيين'}</NavLink>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-b border-gray-200">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link to={`${prefix}/annuaire-partenaires`} onClick={closeMenu} className={linkClass(`${prefix}/annuaire-partenaires`)}>{lang === 'fr' ? 'Annuaire Pro' : 'دليل المهنيين'}</Link>
